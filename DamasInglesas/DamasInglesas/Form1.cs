    ...
    public partial class Form1 : Form
    {
        ...
        private void movimiento(PictureBox cuadro)
        {
            if (seleccionado != null)
            {
                ...
                if (validacion(seleccionado, cuadro, color))//VALIDACION
                {
        ...
        private bool validacion(PictureBox origen, PictureBox destino, string color)
        {
            ...
            avance = color == "rojas" ? avance : (avance * -1);
        ...
        private void ifqueen(string color)
        {
            ...
            {
                seleccionado.BackgroundImage = Properties.Resources.Reina_azul_para_damas;
                seleccionado.Tag = "queen";
            }

            else if (color == "roja" && seleccionado.Location.Y == 50)
            {
                seleccionado.BackgroundImage = Properties.Resources.Reina_rojo_para_damas;
                seleccionado.Tag = "queen";
            }
        }
